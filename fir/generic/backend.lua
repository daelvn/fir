...
local _anon_func_0 = function(language)
...
local _anon_func_1 = function(language)
	local _obj_0 = language.multi
	if _obj_0 ~= nil then
		return _obj_0[2]
	end
...
local _anon_func_2 = function(part)
	local _accum_0 = { }
	local _len_0 = 1
	for _index_0 = 1, #part do
		local l = part[_index_0]
		_accum_0[_len_0] = l
		_len_0 = _len_0 + 1
	end
	return _accum_0
...
extract = function(input, language, options)
	...
	if options.patterns then
		...
		multis = (sanitize(_anon_func_0(language) or false))
		multie = (sanitize(_anon_func_1(language) or false))
	end
	for lc = 1, #lt do
		local line = lt[lc]
